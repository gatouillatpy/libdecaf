...
#ifndef __DECAF_ED168_H__
#define __DECAF_ED168_H__ 1
...
#define DECAF_EDDSA_168_PUBLIC_BYTES 22

/** Number of bytes in an EdDSA private key. */
#define DECAF_EDDSA_168_PRIVATE_BYTES DECAF_EDDSA_168_PUBLIC_BYTES

/** Number of bytes in an EdDSA private key. */
#define DECAF_EDDSA_168_SIGNATURE_BYTES (DECAF_EDDSA_168_PUBLIC_BYTES + DECAF_EDDSA_168_PRIVATE_BYTES)

/** Does EdDSA support non-contextual signatures? */
#define DECAF_EDDSA_168_SUPPORTS_CONTEXTLESS_SIGS 1
extern const uint8_t * const DECAF_ED168_NO_CONTEXT DECAF_API_VIS;


/** Prehash context (raw), because each EdDSA instance has a different prehash. */
#define decaf_ed168_prehash_ctx_s   decaf_shake256_ctx_s

/** Prehash context, array[1] form. */
#define decaf_ed168_prehash_ctx_t   decaf_shake256_ctx_t
    
/** Prehash update. */
#define decaf_ed168_prehash_update  decaf_shake256_update
    
/** Prehash destroy. */
#define decaf_ed168_prehash_destroy decaf_shake256_destroy

/** EdDSA encoding ratio. */
#define DECAF_168_EDDSA_ENCODE_RATIO 4

/** EdDSA decoding ratio. */
#define DECAF_168_EDDSA_DECODE_RATIO (4 / 4)
...
void decaf_ed168_prehash_init (
    decaf_ed168_prehash_ctx_t hash
 ...
 * Multiplies by DECAF_168_EDDSA_ENCODE_RATIO first.
 *
 ...
 * DECAF_168_EDDSA_DECODE_RATIO when decoding, and by
 * DECAF_168_EDDSA_ENCODE_RATIO when encoding.  The product of these
 ...
 * this function, you will get DECAF_168_EDDSA_ENCODE_RATIO times the
 * EdDSA base point.
 *
 * @param [out] enc The encoded point.
 * @param [in] p The point.
 */       
void decaf_168_point_mul_by_ratio_and_encode_like_eddsa (
    uint8_t enc[DECAF_EDDSA_168_PUBLIC_BYTES],
    const decaf_168_point_t p
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;

/**
 * @brief EdDSA point decoding.  Multiplies by DECAF_168_EDDSA_DECODE_RATIO,
 * and ignores cofactor information.
 *
 * See notes on decaf_168_point_mul_by_ratio_and_encode_like_eddsa
 *
 * @param [out] enc The encoded point.
 * @param [in] p The point.
 */       
decaf_error_t decaf_168_point_decode_like_eddsa_and_mul_by_ratio (
    decaf_168_point_t p,
