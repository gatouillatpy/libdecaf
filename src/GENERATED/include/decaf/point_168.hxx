 ...
 * curve (isogenous to E-168) and wiping out the cofactor.
 *
...
#ifndef __DECAF_POINT_168_HXX__
#define __DECAF_POINT_168_HXX__ 1
...
/**
 * E-168/Decaf instantiation of group.
 */
struct E168 {

/** The name of the curve */
static inline const char *name() { return "E-168"; }

/** The name of the curve */
static inline int bits() { return 168; }
...
public:
    /** wrapped C type */
    typedef decaf_168_scalar_t Wrapped;
    
    /** Size of a serialized element */
    static const size_t SER_BYTES = DECAF_168_SCALAR_BYTES;
    ...
    inline Scalar(const Wrapped &t = decaf_168_scalar_zero) DECAF_NOEXCEPT { decaf_168_scalar_copy(s,t); }
    ...
    inline void serialize_into(unsigned char *buffer) const DECAF_NOEXCEPT {
        decaf_168_scalar_encode(buffer, s);
    }

    /** Assignment. */
    inline Scalar& operator=(const Scalar &x) DECAF_NOEXCEPT { decaf_168_scalar_copy(s,x.s); return *this; }

    /** Assign from unsigned 64-bit integer. */
    inline Scalar& operator=(uint64_t w) DECAF_NOEXCEPT { decaf_168_scalar_set_unsigned(s,w); return *this; }


    /** Assign from signed int. */
    inline Scalar& operator=(int64_t w) DECAF_NOEXCEPT {
        Scalar t(-(uint64_t)INT_MIN);
        decaf_168_scalar_set_unsigned(s,(uint64_t)w - (uint64_t)INT_MIN);
        *this -= t;
        return *this;
    }
    ...
    static inline decaf_error_t DECAF_WARN_UNUSED decode (
        ...
        return decaf_168_scalar_decode(sc.s,buffer.data());
    }

    /** Add. */
    inline Scalar operator+ (const Scalar &q) const DECAF_NOEXCEPT { Scalar r((NOINIT())); decaf_168_scalar_add(r.s,s,q.s); return r; }

    /** Add to this. */
    inline Scalar &operator+=(const Scalar &q) DECAF_NOEXCEPT { decaf_168_scalar_add(s,s,q.s); return *this; }

    /** Subtract. */
    inline Scalar operator- (const Scalar &q) const DECAF_NOEXCEPT { Scalar r((NOINIT())); decaf_168_scalar_sub(r.s,s,q.s); return r; }

    /** Subtract from this. */
    inline Scalar &operator-=(const Scalar &q) DECAF_NOEXCEPT { decaf_168_scalar_sub(s,s,q.s); return *this; }

    /** Multiply */
    inline Scalar operator* (const Scalar &q) const DECAF_NOEXCEPT { Scalar r((NOINIT())); decaf_168_scalar_mul(r.s,s,q.s); return r; }

    /** Multiply into this. */
    inline Scalar &operator*=(const Scalar &q) DECAF_NOEXCEPT { decaf_168_scalar_mul(s,s,q.s); return *this; }

    /** Negate */
    inline Scalar operator- () const DECAF_NOEXCEPT { Scalar r((NOINIT())); decaf_168_scalar_sub(r.s,decaf_168_scalar_zero,s); return r; }
    ...
    inline Scalar inverse() const /*throw(CryptoException)*/ {
        Scalar r;
        if (DECAF_SUCCESS != decaf_168_scalar_invert(r.s,s)) {
    ...
    inverse_noexcept(Scalar &r) const DECAF_NOEXCEPT {
        return decaf_168_scalar_invert(r.s,s);
    }
    ...
    inline Scalar half() const { Scalar out; decaf_168_scalar_halve(out.s,s); return out; }

    /** Compare in constant time */
    inline bool operator!=(const Scalar &q) const DECAF_NOEXCEPT { return !(*this == q); }

    /** Compare in constant time */
    inline bool operator==(const Scalar &q) const DECAF_NOEXCEPT { return !!decaf_168_scalar_eq(s,q.s); }
...
public:
    /** Wrapped C type */
    typedef decaf_168_point_t Wrapped;
    
    /** Size of a serialized element */
    static const size_t SER_BYTES = DECAF_168_SER_BYTES;

    /** Bytes required for hash */
    static const size_t HASH_BYTES = DECAF_168_HASH_BYTES;

    /** Bytes required for EdDSA encoding */
    static const size_t EDDSA_BYTES = DECAF_EDDSA_168_PUBLIC_BYTES;

    /** Bytes required for EdDSA encoding */
    static const size_t LADDER_BYTES = DECAF_X168_PUBLIC_BYTES;
    
    /** Ratio due to EdDSA encoding */
    static const int EDDSA_ENCODE_RATIO = DECAF_168_EDDSA_ENCODE_RATIO;
    
    /** Ratio due to EdDSA decoding */
    static const int EDDSA_DECODE_RATIO = DECAF_168_EDDSA_DECODE_RATIO;
    
    /** Ratio due to ladder decoding */
    static const int LADDER_ENCODE_RATIO = DECAF_X168_ENCODE_RATIO;
    ...
    static const unsigned int INVERT_ELLIGATOR_WHICH_BITS = DECAF_168_INVERT_ELLIGATOR_WHICH_BITS;
    ...
    inline Point(const Wrapped &q = decaf_168_point_identity) DECAF_NOEXCEPT { decaf_168_point_copy(p,q); }

    /** Copy constructor. */
    inline Point(const Point &q) DECAF_NOEXCEPT { *this = q; }

    /** Assignment. */
    inline Point& operator=(const Point &q) DECAF_NOEXCEPT { decaf_168_point_copy(p,q.p); return *this; }

    /** Destructor securely zeorizes the point. */
    inline ~Point() DECAF_NOEXCEPT { decaf_168_point_destroy(p); }
    ...
    */
    ...
    inline decaf_error_t DECAF_WARN_UNUSED decode (
        ...
        return decaf_168_point_decode(p,buffer.data(),allow_identity ? DECAF_TRUE : DECAF_FALSE);
    }
    ...
    inline decaf_error_t DECAF_WARN_UNUSED decode_like_eddsa_and_mul_by_ratio_noexcept (
        const FixedBlock<DECAF_EDDSA_168_PUBLIC_BYTES> &buffer
    ) DECAF_NOEXCEPT {
        return decaf_168_point_decode_like_eddsa_and_mul_by_ratio(p,buffer.data());
    }
    ...
    inline SecureBuffer mul_by_ratio_and_encode_like_eddsa() const {
        SecureBuffer ret(DECAF_EDDSA_168_PUBLIC_BYTES);
        decaf_168_point_mul_by_ratio_and_encode_like_eddsa(ret.data(),p);
        return ret;
    }

    /** Multiply by EDDSA_ENCODE_RATIO and encode like EdDSA. */
    inline void mul_by_ratio_and_encode_like_eddsa(
        FixedBuffer<DECAF_EDDSA_168_PUBLIC_BYTES> &out
    ) const {
        decaf_168_point_mul_by_ratio_and_encode_like_eddsa(out.data(),p);
    }
    ...
    inline SecureBuffer mul_by_ratio_and_encode_like_ladder() const {
        ...
        decaf_168_point_mul_by_ratio_and_encode_like_x168(ret.data(),p);
        return ret;
    }

    /** Multiply by LADDER_ENCODE_RATIO and encode like X25519/X448. */
    inline void mul_by_ratio_and_encode_like_ladder(FixedBuffer<LADDER_BYTES> &out) const {
        decaf_168_point_mul_by_ratio_and_encode_like_x168(out.data(),p);
    }
    ...
    inline void set_to_hash( const Block &s ) DECAF_NOEXCEPT {
        if (s.size() < HASH_BYTES) {
            ...
            decaf_168_point_from_hash_nonuniform(p,b.data());
        } else if (s.size() == HASH_BYTES) {
            decaf_168_point_from_hash_nonuniform(p,s.data());
        } else if (s.size() < 2*HASH_BYTES) {
            SecureBuffer b(2*HASH_BYTES);
            memcpy(b.data(), s.data(), s.size());
            decaf_168_point_from_hash_uniform(p,b.data());
        } else {
            decaf_168_point_from_hash_uniform(p,s.data());
        }
    }
    ...
    inline operator SecureBuffer() const {
        ...
        decaf_168_point_encode(buffer.data(), p);
        return buffer;
    }
    ...
    /** Serializable instance */
    inline void serialize_into(unsigned char *buffer) const DECAF_NOEXCEPT {
        decaf_168_point_encode(buffer, p);
    }

    /** Point add. */
    inline Point operator+ (const Point &q) const DECAF_NOEXCEPT { Point r((NOINIT())); decaf_168_point_add(r.p,p,q.p); return r; }

    /** Point add. */
    inline Point &operator+=(const Point &q) DECAF_NOEXCEPT { decaf_168_point_add(p,p,q.p); return *this; }

    /** Point subtract. */
    inline Point operator- (const Point &q) const DECAF_NOEXCEPT { Point r((NOINIT())); decaf_168_point_sub(r.p,p,q.p); return r; }

    /** Point subtract. */
    inline Point &operator-=(const Point &q) DECAF_NOEXCEPT { decaf_168_point_sub(p,p,q.p); return *this; }

    /** Point negate. */
    inline Point operator- () const DECAF_NOEXCEPT { Point r((NOINIT())); decaf_168_point_negate(r.p,p); return r; }

    /** Double the point out of place. */
    inline Point times_two () const DECAF_NOEXCEPT { Point r((NOINIT())); decaf_168_point_double(r.p,p); return r; }

    /** Double the point in place. */
    inline Point &double_in_place() DECAF_NOEXCEPT { decaf_168_point_double(p,p); return *this; }

    /** Constant-time compare. */
    inline bool operator!=(const Point &q) const DECAF_NOEXCEPT { return ! decaf_168_point_eq(p,q.p); }

    /** Constant-time compare. */
    inline bool operator==(const Point &q) const DECAF_NOEXCEPT { return !!decaf_168_point_eq(p,q.p); }

    /** Scalar multiply. */
    inline Point operator* (const Scalar &s) const DECAF_NOEXCEPT { Point r((NOINIT())); decaf_168_point_scalarmul(r.p,p,s.s); return r; }

    /** Scalar multiply in place. */
    inline Point &operator*=(const Scalar &s) DECAF_NOEXCEPT { decaf_168_point_scalarmul(p,p,s.s); return *this; }
    ...
    inline bool validate() const DECAF_NOEXCEPT { return decaf_168_point_valid(p) == DECAF_TRUE; }
    ...
    static inline Point double_scalarmul (
        ...
        Point p((NOINIT())); decaf_168_point_double_scalarmul(p.p,q.p,qs.s,r.p,rs.s); return p;
    }
    ...
    inline void dual_scalarmul (
        ...
        decaf_168_point_dual_scalarmul(q1.p,q2.p,p,r1.s,r2.s);
    }
    ...
    inline Point non_secret_combo_with_base(const Scalar &s, const Scalar &s_base) DECAF_NOEXCEPT {
        Point r((NOINIT())); decaf_168_base_double_scalarmul_non_secret(r.p,s_base.s,p,s.s); return r;
    }
    ...
    inline Point debugging_torque() const DECAF_NOEXCEPT {
        Point q;
        decaf_168_point_debugging_torque(q.p,p);
        return q;
    }
    ...
    inline Point debugging_pscale(const FixedBlock<SER_BYTES> factor) const DECAF_NOEXCEPT {
        Point q;
        decaf_168_point_debugging_pscale(q.p,p,factor.data());
        return q;
    }
    ...
    inline decaf_error_t invert_elligator (
        ...
        if (buf.size() > HASH_BYTES) {
            ret = decaf_successful(decaf_168_invert_elligator_uniform(buf2, p, hint));
        } else {
            ret = decaf_successful(decaf_168_invert_elligator_nonuniform(buf2, p, hint));
        }
        if (buf.size() < HASH_BYTES) {
    ...
    static inline const Point base() DECAF_NOEXCEPT { return Point(decaf_168_point_base); }

    /** Return the identity point of the curve. */
    static inline const Point identity() DECAF_NOEXCEPT { return Point(decaf_168_point_identity); }
};
...
/** @cond internal */
typedef decaf_168_precomputed_s Precomputed_U;
/** @endcond */
class Precomputed
    /** @cond internal */
...
public:
     ...
     */
    inline Precomputed (
        const Precomputed_U &yours = *decaf_168_precomputed_base
    ...
    inline Precomputed &operator=(const Point &it) /*throw(std::bad_alloc)*/ {
        alloc();
        decaf_168_precompute(ours.mine,it.p);
        return *this;
    }
    ...
    inline Point operator* (const Scalar &s) const DECAF_NOEXCEPT { Point r; decaf_168_precomputed_scalarmul(r.p,get(),s.s); return r; }
...
public:
    ...
    static inline size_t size() DECAF_NOEXCEPT { return decaf_168_sizeof_precomputed_s; }
    static inline size_t alignment() DECAF_NOEXCEPT { return decaf_168_alignof_precomputed_s; }
    static inline const Precomputed_U * default_value() DECAF_NOEXCEPT { return decaf_168_precomputed_base; }
    /** @endcond */
};
...
struct DhLadder {
public:
    /** Bytes in an X168 public key. */
    static const size_t PUBLIC_BYTES = DECAF_X168_PUBLIC_BYTES;

    /** Bytes in an X168 private key. */
    static const size_t PRIVATE_BYTES = DECAF_X168_PRIVATE_BYTES;

    /** Base point for a scalar multiplication. */
    static const FixedBlock<PUBLIC_BYTES> base_point() DECAF_NOEXCEPT {
        return FixedBlock<PUBLIC_BYTES>(decaf_x168_base_point);
    }
    ...
    static inline SecureBuffer shared_secret(
        ...
        if (DECAF_SUCCESS != decaf_x168(out.data(), pk.data(), scalar.data())) {
            throw CryptoException();
        }
        return out;
    }
    ...
    shared_secret_noexcept (
       ...
       return decaf_x168(out.data(), pk.data(), scalar.data());
    }
    ...
    generate_key(
        ...
        SecureBuffer out(PUBLIC_BYTES);
        decaf_x168_derive_public_key(out.data(), scalar.data());
        return out;
    }
...
/** @cond internal */
inline SecureBuffer E168::Scalar::direct_scalarmul (
    const FixedBlock<E168::Point::SER_BYTES> &in,
    decaf_bool_t allow_identity,
    decaf_bool_t short_circuit
) const /*throw(CryptoException)*/ {
    SecureBuffer out(E168::Point::SER_BYTES);
    if (DECAF_SUCCESS !=
        decaf_168_direct_scalarmul(out.data(), in.data(), s, allow_identity, short_circuit)
    ) {
        throw CryptoException();
    }
    return out;
...
inline decaf_error_t E168::Scalar::direct_scalarmul_noexcept (
    FixedBuffer<E168::Point::SER_BYTES> &out,
    const FixedBlock<E168::Point::SER_BYTES> &in,
    decaf_bool_t allow_identity,
    decaf_bool_t short_circuit
) const DECAF_NOEXCEPT {
    return decaf_168_direct_scalarmul(out.data(), in.data(), s, allow_identity, short_circuit);
}
/** @endcond */

/** Alternative name for E168, for backwards compatibility */
typedef E168 Telex;
