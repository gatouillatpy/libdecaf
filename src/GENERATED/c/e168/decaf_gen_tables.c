...
static const unsigned char base_point_ser_for_pregen[SER_BYTES] = {
    0xa8, 0x92, 0x17, 0x05, 0xd6, 0xb5, 0x66, 0x91, 0x36, 0x12, 0xd9, 0x91, 0x73, 0x30, 0x15, 0xf3, 0xee, 0x9a, 0x30, 0xe7, 0x5a
};
...
int main(int argc, char **argv) {
    ...
    printf("#define API_NS(_id) decaf_168_##_id\n");
