 ...
 *
 * @brief A group of prime order p, based on E-168.
 *
 * @warning This file was automatically generated in Python.
 * Please do not edit it.
 */

#ifndef __DECAF_POINT_168_H__
#define __DECAF_POINT_168_H__ 1
...
/** @cond internal */
#define DECAF_168_SCALAR_LIMBS ((166-1)/DECAF_WORD_BITS+1)
/** @endcond */

/** The number of bits in a scalar */
#define DECAF_168_SCALAR_BITS 166

/** @cond internal */
#ifndef __DECAF_168_GF_DEFINED__
#define __DECAF_168_GF_DEFINED__ 1
/** @brief Galois field element internal structure */
#ifdef _MSC_VER
typedef struct gf_168_s {
    decaf_word_t limb[256/DECAF_WORD_BITS];
...
#endif
#endif /* __DECAF_168_GF_DEFINED__ */
/** @endcond */

/** Number of bytes in a serialized point. */
#define DECAF_168_SER_BYTES 21

/** Number of bytes in an elligated point.  For now set the same as SER_BYTES
 * but could be different for other curves.
 */
#define DECAF_168_HASH_BYTES 21

/** Number of bytes in a serialized scalar. */
#define DECAF_168_SCALAR_BYTES 21

/** Number of bits in the "which" field of an elligator inverse */
#define DECAF_168_INVERT_ELLIGATOR_WHICH_BITS 3

/** The cofactor the curve would have, if we hadn't removed it */
#define DECAF_168_REMOVED_COFACTOR 4

/** X168 encoding ratio. */
#define DECAF_X168_ENCODE_RATIO 2

/** Number of bytes in an x168 public key */
#define DECAF_X168_PUBLIC_BYTES 21

/** Number of bytes in an x168 private key */
#define DECAF_X168_PRIVATE_BYTES 21

/** Representation of a point on the elliptic curve. */
typedef struct decaf_168_point_s {
    /** @cond internal */
    gf_168_t x,y,z,t; /* Twisted extended homogeneous coordinates */
    /** @endcond */
} decaf_168_point_t[1];

/** Precomputed table based on a point.  Can be trivial implementation. */
struct decaf_168_precomputed_s;

/** Precomputed table based on a point.  Can be trivial implementation. */
typedef struct decaf_168_precomputed_s decaf_168_precomputed_s; 

/** Size and alignment of precomputed point tables. */
extern const size_t decaf_168_sizeof_precomputed_s DECAF_API_VIS, decaf_168_alignof_precomputed_s DECAF_API_VIS;

/** Representation of an element of the scalar field. */
typedef struct decaf_168_scalar_s {
    /** @cond internal */
    decaf_word_t limb[DECAF_168_SCALAR_LIMBS];
    /** @endcond */
} decaf_168_scalar_t[1];

/** The scalar 1. */
extern const decaf_168_scalar_t decaf_168_scalar_one DECAF_API_VIS;

/** The scalar 0. */
extern const decaf_168_scalar_t decaf_168_scalar_zero DECAF_API_VIS;

/** The identity (zero) point on the curve. */
extern const decaf_168_point_t decaf_168_point_identity DECAF_API_VIS;

/** An arbitrarily-chosen base point on the curve. */
extern const decaf_168_point_t decaf_168_point_base DECAF_API_VIS;

/** Precomputed table of multiples of the base point on the curve. */
extern const struct decaf_168_precomputed_s *decaf_168_precomputed_base DECAF_API_VIS;
 ...
 */
decaf_error_t decaf_168_scalar_decode (
    decaf_168_scalar_t out,
    const unsigned char ser[DECAF_168_SCALAR_BYTES]
 ...
 * @param [out] out Deserialized form.
 */
void decaf_168_scalar_decode_long (
    decaf_168_scalar_t out,
 ...
 */
void decaf_168_scalar_encode (
    unsigned char ser[DECAF_168_SCALAR_BYTES],
    const decaf_168_scalar_t s
 ...
 * @param [out] out a+b.
 */
void decaf_168_scalar_add (
    decaf_168_scalar_t out,
    const decaf_168_scalar_t a,
    const decaf_168_scalar_t b
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 */    
decaf_bool_t decaf_168_scalar_eq (
    const decaf_168_scalar_t a,
    const decaf_168_scalar_t b
) DECAF_API_VIS DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 */  
decaf_error_t decaf_168_scalar_invert (
    decaf_168_scalar_t out,
    const decaf_168_scalar_t a
) DECAF_API_VIS DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
static inline void DECAF_NONNULL decaf_168_scalar_copy (
    decaf_168_scalar_t out,
    const decaf_168_scalar_t a
) {
    *out = *a;
 ...
 */  
void decaf_168_scalar_set_unsigned (
    decaf_168_scalar_t out,
    uint64_t a
 ...
 */
void decaf_168_point_encode (
    uint8_t ser[DECAF_168_SER_BYTES],
    const decaf_168_point_t pt
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
decaf_error_t decaf_168_point_decode (
    decaf_168_point_t pt,
    const uint8_t ser[DECAF_168_SER_BYTES],
 ...
 */
static inline void DECAF_NONNULL decaf_168_point_copy (
    decaf_168_point_t a,
    const decaf_168_point_t b
) {
    *a=*b;
}
 ...
 */
decaf_bool_t decaf_168_point_eq (
    const decaf_168_point_t a,
    const decaf_168_point_t b
) DECAF_API_VIS DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
void decaf_168_point_add (
    decaf_168_point_t sum,
    const decaf_168_point_t a,
    const decaf_168_point_t b
) DECAF_API_VIS DECAF_NONNULL;
 ...
 * decaf_168_point_add(two_a,a,a), but potentially faster.
 *
 * @param [out] two_a The sum a+a.
 * @param [in] a A point.
 */
void decaf_168_point_double (
    decaf_168_point_t two_a,
    const decaf_168_point_t a
) DECAF_API_VIS DECAF_NONNULL;
 ...
 */
void decaf_168_point_sub (
    decaf_168_point_t diff,
    const decaf_168_point_t a,
    const decaf_168_point_t b
) DECAF_API_VIS DECAF_NONNULL;
 ...
 */
void decaf_168_point_negate (
   decaf_168_point_t nega,
   const decaf_168_point_t a
) DECAF_API_VIS DECAF_NONNULL;
 ...
 */
void decaf_168_point_scalarmul (
    decaf_168_point_t scaled,
    const decaf_168_point_t base,
    const decaf_168_scalar_t scalar
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
decaf_error_t decaf_168_direct_scalarmul (
    uint8_t scaled[DECAF_168_SER_BYTES],
    const uint8_t base[DECAF_168_SER_BYTES],
    const decaf_168_scalar_t scalar,
    decaf_bool_t allow_identity,
...
decaf_error_t decaf_x168 (
    uint8_t shared[DECAF_X168_PUBLIC_BYTES],
    const uint8_t base[DECAF_X168_PUBLIC_BYTES],
    const uint8_t scalar[DECAF_X168_PRIVATE_BYTES]
) DECAF_API_VIS DECAF_NONNULL DECAF_WARN_UNUSED DECAF_NOINLINE;

/**
 * @brief Multiply a point by DECAF_X168_ENCODE_RATIO,
 ...
 * will be DECAF_X168_ENCODE_RATIO times the X168
 * base point.
 *
 * @param [out] out The scaled and encoded point.
 * @param [in] p The point to be scaled and encoded.
 */
void decaf_168_point_mul_by_ratio_and_encode_like_x168 (
    uint8_t out[DECAF_X168_PUBLIC_BYTES],
    const decaf_168_point_t p
) DECAF_API_VIS DECAF_NONNULL;

/** The base point for X168 Diffie-Hellman */
extern const uint8_t
    decaf_x168_base_point[DECAF_X168_PUBLIC_BYTES]
#ifndef DOXYGEN
 ...
 *
 * @deprecated Renamed to decaf_x168_derive_public_key.
...
void decaf_x168_generate_key (
    uint8_t out[DECAF_X168_PUBLIC_BYTES],
    const uint8_t scalar[DECAF_X168_PRIVATE_BYTES]
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE DECAF_DEPRECATED("Renamed to decaf_x168_derive_public_key");
    
/**
 * @brief RFC 7748 Diffie-Hellman base point scalarmul.  This function uses
 * a different (non-Decaf) encoding.
 *
 * Does exactly the same thing as decaf_x168_generate_key,
...
/* FUTURE: uint8_t decaf_168_encode_like_curve168) */
 ...
 * @param [in] b Any point.
 */
void decaf_168_precompute (
    decaf_168_precomputed_s *a,
    const decaf_168_point_t b
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 * decaf_168_point_scalarmul
 *
 * @param [out] scaled The scaled point base*scalar
 * @param [in] base The point to be scaled.
 * @param [in] scalar The scalar to multiply by.
 */
void decaf_168_precomputed_scalarmul (
    decaf_168_point_t scaled,
    const decaf_168_precomputed_s *base,
    const decaf_168_scalar_t scalar
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 *
 * Equivalent to two calls to decaf_168_point_scalarmul, but may be
 * faster.
 *
 ...
 */
void decaf_168_point_double_scalarmul (
    decaf_168_point_t combo,
    const decaf_168_point_t base1,
    const decaf_168_scalar_t scalar1,
    const decaf_168_point_t base2,
    const decaf_168_scalar_t scalar2
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 * @param [in] scalar2 A second scalar to multiply by.
 */
void decaf_168_point_dual_scalarmul (
    decaf_168_point_t a1,
    decaf_168_point_t a2,
    const decaf_168_point_t base1,
    const decaf_168_scalar_t scalar1,
    const decaf_168_scalar_t scalar2
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
...
/**
 * @brief Multiply two base points by two scalars:
 * scaled = scalar1*decaf_168_point_base + scalar2*base2.
 *
 * Otherwise equivalent to decaf_168_point_double_scalarmul, but may be
 ...
 */
void decaf_168_base_double_scalarmul_non_secret (
    decaf_168_point_t combo,
    const decaf_168_scalar_t scalar1,
    const decaf_168_point_t base2,
    const decaf_168_scalar_t scalar2
 ...
 */
void decaf_168_point_cond_sel (
    decaf_168_point_t out,
    const decaf_168_point_t a,
    const decaf_168_point_t b,
    decaf_word_t pick_b
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
void decaf_168_scalar_cond_sel (
    decaf_168_scalar_t out,
    const decaf_168_scalar_t a,
    const decaf_168_scalar_t b,
    decaf_word_t pick_b
 ...
 */
decaf_bool_t decaf_168_point_valid (
    const decaf_168_point_t to_test
) DECAF_API_VIS DECAF_WARN_UNUSED DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
void decaf_168_point_debugging_torque (
    decaf_168_point_t q,
    const decaf_168_point_t p
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 */
void decaf_168_point_debugging_pscale (
    decaf_168_point_t q,
    const decaf_168_point_t p,
    const unsigned char factor[DECAF_168_SER_BYTES]
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 *
 * This function runs Elligator2 on the decaf_168 Jacobi quartic model.  It then
 ...
 */
void
decaf_168_point_from_hash_nonuniform (
    decaf_168_point_t pt,
    const unsigned char hashed_data[DECAF_168_HASH_BYTES]
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;

/**
 * @brief Indifferentiable hash function encoding to curve.
 *
 * Equivalent to calling decaf_168_point_from_hash_nonuniform twice and adding.
 *
 * @param [in] hashed_data Output of some hash function.
 * @param [out] pt The data hashed to the curve.
 */ 
void decaf_168_point_from_hash_uniform (
    decaf_168_point_t pt,
    const unsigned char hashed_data[2*DECAF_168_HASH_BYTES]
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE;
 ...
 * decaf_168_point_from_hash_nonuniform(buffer) = pt if
 ...
 */
decaf_error_t
decaf_168_invert_elligator_nonuniform (
    unsigned char recovered_hash[DECAF_168_HASH_BYTES],
    const decaf_168_point_t pt,
    uint32_t which
 ...
 *
 * This function writes to the buffer, to make it so that
 * decaf_168_point_from_hash_uniform(buffer) = pt if
 * possible.  Since there may be multiple preimages, the
 * "which" parameter chooses between them.  To ensure uniform
 * inverse sampling, this function succeeds or fails
 * independently for different "which" values.
 ...
 */
decaf_error_t
decaf_168_invert_elligator_uniform (
    unsigned char recovered_hash[2*DECAF_168_HASH_BYTES],
    const decaf_168_point_t pt,
    uint32_t which
) DECAF_API_VIS DECAF_NONNULL DECAF_NOINLINE DECAF_WARN_UNUSED;

/** Securely erase a scalar. */
void decaf_168_scalar_destroy (
    decaf_168_scalar_t scalar
